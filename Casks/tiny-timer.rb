...
cask "tiny-timer" do
  ...
  name "tiny-timer"
  desc "Simple command-line Pomodoro timer with an animated progress bar"
  ...
  postflight do
    system_command "/usr/bin/xattr", args: ["-dr", "com.apple.quarantine", "#{staged_path}/tiny-timer"] if OS.mac?
  end
